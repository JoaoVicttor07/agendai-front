    ...
    <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex gap-3 md:order-2 rtl:gap-reverse">
          ...
          <Button
          asChild
          className="border-2 border-blue-700 rounded-3xl text-sm text-blue-700 dark:border-blue-500 dark:text-white cursor-pointer" 
          variant="outline"
          >
        ...
        >
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-100 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <Link
                href="#start"
                onClick={handleNavClick}
