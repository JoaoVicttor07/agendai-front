...
import { CheckCircle2, CalendarClock, HelpCircle, ShieldCheck } from "lucide-react"
...
export default function SchedulePage() {
  ...
  const isStepValid = React.useMemo(() => {
    ...
    if (step === 1) {
      return !!form.especialidade && !!form.tipo
    }
    if (step === 2) {
      ...
      <main className="pt-16">
            ...
            <Card className="lg:col-span-2">
              ...
              <CardContent className="space-y-6">
                ...
                {step === 1 && (
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div className="sm:col-span-2">
                      <span className="mb-2 block text-sm font-medium">Tipo de atendimento</span>
                        ...
                        {(["Online", "Presencial"] as const).map((tipo) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <CheckCircle2 className={clsx("size-5", selected ? "opacity-100" : "opacity-0")} />
                            </button>
                          )
                        })}
                      </div>
                ...
                {step === 3 && (
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <ResumoItem label="Data" value={form.data && formatarData(form.data)} />
              ...
              <CardFooter className="flex items-center justify-between">
                ...
                {step < totalSteps - 1 ? (
                  ...
                  <Button onClick={confirmarAgendamento} disabled={!isStepValid}>
              ...
              <Card>
                ...
                <CardFooter className="border-t">
                  <div className="flex w-full items-center justify-between">
                    ...
                    <a className="text-sm font-medium text-primary underline-offset-4 hover:underline" href="mailto:suporte@agendai.com">
                      Fale com o suporte
                    </a>
                  </div>
                </CardFooter>
        ...
        <AlertDialog open={dialogOpen} onOpenChange={setDialogOpen}>
          <AlertDialogContent>
            ...
            <AlertDialogFooter>
              <AlertDialogCancel onClick={() => setDialogOpen(false)}>Fechar</AlertDialogCancel>
              <AlertDialogAction
                asChild
              >
